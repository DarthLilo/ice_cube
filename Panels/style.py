...
class ICECUBERIG_PT_StyleEmotions(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row.prop(obj,"emotion_eyebags",text="Eyebags",toggle=True)
        
        main_row = layout.row(align=True)
        main_row.label(text="Emotion Lines",icon='OUTLINER_DATA_CURVES')
        main_row = layout.row(align=True)
        emotions_R = main_row.column(align=True)
        emotions_L = main_row.column(align=True)

        emotions_R.prop(obj,"emotion_eyebrow_point_R",text="Eyebrow Point R",toggle=True)
        emotions_R.prop(obj,"emotion_eyebrow_line_R",text="Eyebrow Line R",toggle=True)
        emotions_R.prop(obj,"emotion_eyebrow_line_U_R",text="Eyebrow Line Upper R",toggle=True)
        emotions_R.prop(obj,"emotion_eyebrow_shocked_R",text="Eyebrow Shocked R",toggle=True)
        emotions_R.prop(obj,"emotion_eye_line_R",text="Eye Line R",toggle=True)
        emotions_R.prop(obj,"emotion_eye_point_R",text="Eye Point R",toggle=True)
        emotions_R.prop(obj,"emotion_eye_shocked_R",text="Eye Shocked R",toggle=True)

        emotions_L.prop(obj,"emotion_eyebrow_point_L",text="Eyebrow Point L",toggle=True)
        emotions_L.prop(obj,"emotion_eyebrow_line_L",text="Eyebrow Line L",toggle=True)
        emotions_L.prop(obj,"emotion_eyebrow_line_U_L",text="Eyebrow Line Upper L",toggle=True)
        emotions_L.prop(obj,"emotion_eyebrow_shocked_L",text="Eyebrow Shocked L",toggle=True)
        emotions_L.prop(obj,"emotion_eye_line_L",text="Eye Line L",toggle=True)
        emotions_L.prop(obj,"emotion_eye_point_L",text="Eye Point L",toggle=True)
        emotions_L.prop(obj,"emotion_eye_shocked_L",text="Eye Shocked L",toggle=True)
...
class ICECUBERIG_PT_StyleMaterialEYES(bpy.types.Panel):
    bl_label = "Eyes"
    bl_idname = "ICECUBERIG_PT_StyleMaterialEYES"
    bl_space_type = "VIEW_3D"
    bl_region_type = 'UI'
    bl_category = "Ice Cube v2"
    bl_parent_id = "ICECUBERIG_PT_StyleMaterial"
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        eyes_row = layout.row(align=True)
        ...
        if eye_node.inputs[42].default_value or eye_node.inputs[43].default_value :
            ...
            eyes_box = layout.box()
            eyes_box_row = eyes_box.row(align=True)
            eyes_box_row.label(text="Emissive Mask Options")
            eyes_box_row = eyes_box.row(align=True)
            eyes_box_row.prop(eye_node.inputs[46],'default_value',text="Pupil",toggle=True)
            eyes_box_row.prop(eye_node.inputs[47],'default_value',text="Sparkle 1",toggle=True)
            eyes_box_row.prop(eye_node.inputs[48],'default_value',text="Sparkle 2",toggle=True)
            eyes_row = layout.row(align=True)
...
class ICECUBERIG_PT_StyleMaterialMISC(bpy.types.Panel):
    bl_label = "Misc"
    bl_idname = "ICECUBERIG_PT_StyleMaterialMISC"
    bl_space_type = "VIEW_3D"
    bl_region_type = 'UI'
    bl_category = "Ice Cube v2"
    bl_parent_id = "ICECUBERIG_PT_StyleMaterial"
    ...
    def draw(self, context):
        ...
        misc_row = layout.row(align=True)
        ...
        misc_row = layout.row(align=True)
        misc_row.label(text="Skin Feature Color")
        misc_row = layout.row(align=True)
        eye_bag = GetMaterial(context,'skin_features')
        misc_row.prop(eye_bag.node_tree.nodes['Principled BSDF'].inputs[0],'default_value',text="")
