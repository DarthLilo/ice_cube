...
def ic_search_ui(self,context,scale):
    ...
    def sep(search_name,property_name,display_name="",index=0,expand=True,toggle=True,slider=True,source=obj):
    ...
    entries = (
        ...
        sep("IK Stretch Leg Left","stretch_leg_l","Left Leg Stretch"),
